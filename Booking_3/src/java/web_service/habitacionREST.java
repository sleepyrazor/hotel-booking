...
/**
 * Jersey REST client generated for REST resource:HabitacionFacadeREST
 * [entidades.habitacion]<br>
 * USAGE:
 * <pre>
 *        habitacionREST client = new habitacionREST();
...
public class habitacionREST {
    ...
    private static final String BASE_URI = "http://localhost:8080/Booking_REST/webresources";

    public habitacionREST() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("entidades.habitacion");
    }
